...
type ProductTemplate struct {
	...
	Category                               *String     `xmlrpc:"category,omitempty"`
	...
	HouseId                                *Many2One   `xmlrpc:"house_id,omitempty"`
	...
	PerPoundCost                           *Float      `xmlrpc:"per_pound_cost,omitempty"`
	PerPoundSalesPrice                     *Float      `xmlrpc:"per_pound_sales_price,omitempty"`
