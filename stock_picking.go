...
type StockPicking struct {
	...
	FinalizedReceiptDate        *Time       `xmlrpc:"finalized_receipt_date,omitempty"`
	...
	IsFinalizedReceipt          *Bool       `xmlrpc:"is_finalized_receipt,omitempty"`
	...
	PoReference                 *String     `xmlrpc:"po_reference,omitempty"`
	...
	ReceiveDetails              *String     `xmlrpc:"receive_details,omitempty"`
	...
	ShowAltQuantity             *Bool       `xmlrpc:"show_alt_quantity,omitempty"`
	...
	SignatureManager            *String     `xmlrpc:"signature_manager,omitempty"`
	SignatureReceiver           *String     `xmlrpc:"signature_receiver,omitempty"`
	SignatureTruckDriver        *String     `xmlrpc:"signature_truck_driver,omitempty"`
